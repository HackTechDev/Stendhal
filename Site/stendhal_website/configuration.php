...
@define('STENDHAL_WEB_USERNAME','root');
@define('STENDHAL_WEB_PASSWORD','mot2passe');
...
@define('STENDHAL_GAME_USERNAME','root');
@define('STENDHAL_GAME_PASSWORD','mot2passe');
@define('STENDHAL_GAME_DB','mauroroa');
...
@define('STENDHAL_LOGIN_TARGET','http://stendhal.localhost');
